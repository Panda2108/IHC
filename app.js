...
createApp({
    setup() {
        ...
        return {
            categories, activeCategory, view, cart, isCartOpen, isSearchOpen, deliveryMethod,
            searchQuery, isVoiceReaderEnabled, isDictationEnabled, isListening, showOrderSuccess,
            countdown, activeOrder, addToCart, updateQty, removeFromCart, handleCheckout,
            filteredProducts, speakProduct, handleListen, formatTime
        };
    }
}).mount('#app');
